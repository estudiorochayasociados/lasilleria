...
if (isset($_POST["agregar"])) {
    ...
    $pagos->set("aumento", $funciones->antihack_mysqli(isset($_POST["aumento"]) ? $_POST["aumento"] : '0'));
    $pagos->set("disminuir", $funciones->antihack_mysqli(isset($_POST["disminuir"]) ? $_POST["disminuir"] : '0'));
