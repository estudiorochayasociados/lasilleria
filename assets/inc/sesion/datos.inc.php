    ...
    <form id="registro" method="post" autocomplete="off">
            ...
            <div class="col-md-6">Localidad
                <div class="input-group">
                    <select class="form-control h40" name="localidad" id="localidad" required>
                        <option value="<?= $usuarioData['localidad'] ?>" selected><?= $usuarioData['localidad'] ?></option>
                    </select>
                    <span class="input-group-addon"><i
                                class="login_icon glyphicon glyphicon-map-marker"></i></span>
                </div>
        ...
        <div class="row">
            <div class="col-md-6">Dirección
                <div class="input-group">
                    <input class="form-control h40" value="<?= $usuarioData['direccion'] ?>" type="text" placeholder="Dirección" name="direccion" required/>
                    <span class="input-group-addon">
        ...
        <br/>
        <button type="submit" name="guardar" class="btn btn-submit mb-40">Guardar</button>
    </form>
</div>